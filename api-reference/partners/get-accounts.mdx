...
description: 'Retrieve all TikTok accounts for a specific user'
---
...
<ResponseField name="accounts" type="array">
  ...
  <Expandable title="Account object">
    ...
    <ResponseField name="username" type="string">
      The account's TikTok username. May be `null` for accounts still in early warmup (before Day 5).
    </ResponseField>
...
| Status | Description |
|--------|-------------|
| `pending_creation` | Phone is provisioned, TikTok account is being set up |
| `warming_up` | Account is created and going through the 7-day warmup period |
